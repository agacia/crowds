...
//		if (a.getId().equals("from1.4") && b.getId().equals("from1.5")) {
//			System.out.println(graph.getStep() +"\t" + a.getId() + " " + b.getId() + " " + "\tnsim:\t"  + super.similarity(a, b) + "\tweight\t" + getWeightInLinkFrom(a, b)  + "\tweighted_w:\t" + (getWeightInLinkFrom(a, b) / maxWeight) + "\tsim\t" + sim);
//		}
		return sim;
	}
